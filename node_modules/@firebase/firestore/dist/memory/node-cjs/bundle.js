...
function loadBundle(data) {
    return database542d2a8c.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database542d2a8c.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database542d2a8c.Query$1(this, 
...
registerBundle(database542d2a8c.Firestore);
