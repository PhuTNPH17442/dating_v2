 ...
 */ var E = "8.5.0-20214541157", T = /** @class */ function() {
    function t(t, e) {
        var n = this;
 ...
 */ function D(t) {
    ...
    if (N.logLevel <= c.DEBUG) {
        var r = e.map(C);
        N.debug.apply(N, _([ "Firestore (" + E + "): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= c.ERROR) {
        var r = e.map(C);
        N.error.apply(N, _([ "Firestore (" + E + "): " + t ], r));
    }
}
...
function R(t) {
    ...
    if (N.logLevel <= c.WARN) {
        var r = e.map(C);
        N.warn.apply(N, _([ "Firestore (" + E + "): " + t ], r));
    }
}
...
/** Extracts the backend's type order for the provided value. */ function st(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? tt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : O();
}
 ...
 */ var wt = /** @class */ function() {
    ...
    t.prototype.delete = function(t) {
        ...
        return ut(this.buildProto(), t.buildProto());
    }, 
    /**
    ...
    t.prototype.applyOverlay = function(e, n) {
        var r = this, i = !1, o = t.extractNestedValue(this.partialValue, e), s = gt(o) ? // If there is already data at the current path, base our
    ...
    t.prototype.buildProto = function() {
        ...
        for (var n = t, r = 0; r < e.length - 1; ++r) {
            ...
            if (!gt(n = n.mapValue.fields[e.get(r)])) return null;
        }
...
var _t = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , q.min(), wt.empty(), 0 /* SYNCED */);
    }, 
    /**
...
var St = /** @class */ function(t) {
     ...
     */    return g(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new Dt(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Ot(t, r) : "in" /* IN */ === n ? new Lt(t, r) : "not-in" /* NOT_IN */ === n ? new Pt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Mt(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
 ...
 */ function Yt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Ut(n)), e.p.push(new Ut(z.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function ae(t, e, n) {
    return t instanceof le ? function(t, e) {
        ...
        return pt(n) && pt(t.A) ? oe(r) : ie(t.R, r);
    }(t, e);
}
 ...
 */ function he(t, e) {
    return t instanceof ve ? pt(n = e) || function(t) {
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && U(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof fe && e instanceof fe || t instanceof pe && e instanceof pe ? U(t.elements, e.elements, ut) : t instanceof ve && e instanceof ve ? ut(t.A, e.A) : t instanceof le && e instanceof le;
...
/** A mutation that deletes the document at the given key. */ var Pe, Me, Ve = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (Me = Pe || (Pe = {}))[Me.OK = 0] = "OK", Me[Me.CANCELLED = 1] = "CANCELLED", 
Me[Me.UNKNOWN = 2] = "UNKNOWN", Me[Me.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
Me[Me.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", Me[Me.NOT_FOUND = 5] = "NOT_FOUND", 
Me[Me.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", Me[Me.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
Me[Me.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", Me[Me.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
Me[Me.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", Me[Me.ABORTED = 10] = "ABORTED", 
Me[Me.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", Me[Me.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
Me[Me.INTERNAL = 13] = "INTERNAL", Me[Me.UNAVAILABLE = 14] = "UNAVAILABLE", Me[Me.DATA_LOSS = 15] = "DATA_LOSS";
...
}(), We = new Be(ot.comparator);

function ze() {
    return We;
}

var He = new Be(ot.comparator);

function Ye() {
    return He;
}

var Xe = new Be(ot.comparator);

function Je() {
    return Xe;
}

var Ze = new Ke(ot.comparator);

function $e() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = Ze, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var nn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, rn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(q.min(), r, en(), ze(), $e());
    }, t;
}(), rn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(Y.EMPTY_BYTE_STRING, n, $e(), $e(), $e());
    }, t;
}(), on = function(
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (Nt(i)) if (0 === n) {
                ...
                // queries.
                var o = new ot(i.path);
                this.tt(e, o, _t.newNoDocument(o, q.min()));
...
function gn(t) {
    return L(!!t), q.fromTimestamp(function(t) {
        var e = J(t);
        return new x(e.seconds, e.nanos);
    }(t));
}
...
function Un(t) {
    return St.create(Fn(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ var Jn = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new Ke(Q.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Ke(Q.comparator)).toArray();
    }, t;
}(), $n = /** @class */ function() {
    function t(t) {
        this.Ht = t;
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Kt(e) || Qt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (S() <= c.DEBUG && D("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), te(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return S() <= c.DEBUG && D("QueryEngine", "Using full collection scan to execute query:", te(e)), 
 ...
 */ function vr(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : q.min(), n ? o : $e());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
 ...
 */ function mr(t, e, n, r) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = P(t), o = $e(), s = ze(), u = Je(), a = 0, c = n; a < c.length; a++) h = c[a], 
                ...
                return f = i.On.newChangeBuffer({
                    ...
                    return Xt(Gt(Q.fromString("__bundle__/docs/" + t)));
                }(r)) ];
              ...
              case 1:
                ...
                return d = p.sent(), [ 2 /*return*/ , i.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return fr(t, f, s, q.min(), u).next((function(e) {
                        return f.apply(t), e;
                    })).next((function(e) {
 ...
 */ var wr = /** @class */ function() {
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new ot(new Q([])), r = new _r(n, t), i = new _r(n, t + 1), o = [];
        ...
        var e = new ot(new Q([])), n = new _r(e, t), r = new _r(e, t + 1), i = $e();
    ...
    return t.Gn = function(t, e) {
        return ot.comparator(t.key, e.key) || F(t.ns, e.ns);
    }, 
    /** Compare by ID then by key */ t.Hn = function(t, e) {
        return F(t.ns, e.ns) || ot.comparator(t.key, e.key);
    }, t;
}(), Er = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new _r(new ot(i), 0), s = new Ke(F);
    ...
    function t(t, e) {
        ...
        this.docs = new Be(ot.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        for (var r = ze(), i = new ot(e.path.child("")), o = this.docs.getIteratorFrom(i)
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._s = new br, this.targetCount = 0, this.ys = $n.Jt();
    }
...
var Rr = /** @class */ function() {
    ...
    return g(u, s), u.prototype.ki = function(t, e, n, r) {
        ...
        var g = c.createWebChannel(f, l), w = !1, b = !1, _ = new Mr({
            Ei: function(t) {
        ...
        return E(g, y.EventType.OPEN, (function() {
            ...
            b || (b = !0, D("Connection", "WebChannel transport closed"), _.Vi());
        })), E(g, y.EventType.ERROR, (function(t) {
            b || (b = !0, R("Connection", "WebChannel transport errored:", t), _.Vi(new A(I.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    b = !0, _.Vi(new A(s, u)), g.close();
                } else D("Connection", "WebChannel received:", n), _.Si(n);
            }
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (L(void 0 === e || "string" == typeof e), Y.fromBase64String(e || "")) : (L(void 0 === e || e instanceof Uint8Array), 
                    Y.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = (u = e.targetChange.cause) && function(t) {
                    var e = void 0 === t.code ? I.UNKNOWN : qe(t.code);
            ...
            i = En(t, r.document), o = r.readTime ? gn(r.readTime) : q.min(), u = _t.newNoDocument(i, o), 
            ...
            return e.targetIds && e.targetIds.length ? q.min() : e.readTime ? gn(e.readTime) : q.min();
        }(t);
    ...
    e.prototype.mr = function(t) {
        ...
        e.database = In(this.R), e.addTarget = function(t, e) {
            ...
            return (n = Nt(r) ? {
                ...
                query: kn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = vn(t, e.resumeToken) : e.snapshotVersion.compareTo(q.min()) > 0 && (
        ...
        n.enqueueAndForget((function() {
            return w(o, void 0, void 0, (function() {
                return b(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ti(this) ? (D("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return w(this, void 0, void 0, (function() {
                                var e;
                                return b(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = P(t)).Or.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , zr(e) ];
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(s) {
            switch (s.label) {
              ...
              case 6:
                if (e instanceof on ? t.qr.X(e) : e instanceof sn ? t.qr.rt(e) : t.qr.et(e), n.isEqual(q.min())) return [ 3 /*break*/ , 13 ];
                s.label = 7;
              ...
              case 11:
                return D("RemoteStore", "Failed to raise snapshot:", o = s.sent()), [ 4 /*yield*/ , oi(t, o) ];
...
function ui(t) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(s) {
            switch (s.label) {
              case 0:
                e = P(t), n = vi(e), r = e.kr.length > 0 ? e.kr[e.kr.length - 1].batchId : -1, s.label = 1;
 ...
 */ function pi(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = P(t), e ? (n.Or.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Wr(n) ]) : [ 3 /*break*/ , 2 ];
    ...
    t.Ur = function(t, e, n) {
        ...
        return w(e, void 0, void 0, (function() {
            return b(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Ur.sr(), $r(t) ? Zr(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
 ...
 */ function gi(t, e) {
    if (k("AsyncQueue", e + ": " + t), Qn(t)) return new A(I.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var wi = /** @class */ function() {
    ...
    this.queries = new er((function(t) {
        return $t(t);
    }), Zt), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ function Ii(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = P(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Ei), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
 ...
 */ var Pi = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = $e(), this.lo = ne(t), this.fo = new wi(this.lo);
    }
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(h) {
            switch (h.label) {
              ...
              case 1:
                return i = h.sent(), o = new Vi(e, i.Bn), s = o._o(i.documents), u = rn.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.applyChanges(s, 
                /* updateLimboDocuments= */ t.isPrimaryClient, u), to(t, n, a.To), c = new Fi(e, n, o), 
    ...
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(o) {
            switch (o.label) {
              ...
              case 3:
                return Zi(n, r.targetId), [ 4 /*yield*/ , yr(n.localStore, r.targetId, 
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new Re(c.key, h, bt(h.toProto().mapValue), _e.exists(!0)));
                            }
        ...
        return b(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new Be(ot.comparator)).insert(o, _t.newNoDocument(o, q.min())), 
                u = $e().add(o), a = new nn(q.min(), 
 ...
 */ function Yi(t, e) {
    return w(this, void 0, void 0, (function() {
        ...
        return b(this, (function(u) {
            switch (u.label) {
              case 0:
                ti((n = P(t)).remoteStore) || D("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                u.label = 1;
...
function to(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Pi ? (t.No.addReference(o.key, e), eo(t, o)) : o instanceof Mi ? (D("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function no(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new Ui(n)), t.Do = t.Do.insert(n, r), Hr(t.remoteStore, new Hn(Xt(Gt(n.path)), r, 2 /* LimboResolution */ , T.o));
    }
}
        ...
        return w(this, void 0, void 0, (function() {
            ...
            return b(this, (function(c) {
                switch (c.label) {
                  ...
                  case 4:
                    return n._updateProgress(Li(r)), i = new Oi(r, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
...
var uo = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t, e) {
        ...
        var e, n = Ur(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Vr(e));
        ...
        }, o = Lr.yt() ? new Lr : new Or, new Qr(e, n, r, i, o);
 ...
 */ var ho = /** @class */ function() {
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return w(this, void 0, void 0, (function() {
                            ...
                            return b(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = P(t), r = In(n.R) + "/documents", i = {
    ...
    e, n) {
        ...
        this.clientId = V.u(), this.credentialListener = function() {}, this.receivedInitialUser = new Gn, 
                    ...
                    r.isEqual(n) || (r = n, t.asyncQueue.enqueueRetryable((function() {
                        return w(i, void 0, void 0, (function() {
                            return b(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , ar(e.localStore, n) ];
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        ...
        this.currentUser = kr.UNAUTHENTICATED, this.receivedInitialUser = !1, 
        /**
    ...
    function t(t, e, n) {
        this.ac = t, this.hc = e, this.lc = n, this.type = "FirstParty", this.user = kr.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Po(this.ac, this.hc, this.lc));
    }, t.prototype.setChangeListener = function(t) {
        ...
        this._settings = new Ko(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              case "gapi":
                ...
                new Mo(e, t.sessionIndex || "0", t.iamToken || null);
 ...
 */
        return t = this, (e = ko.get(t)) && (D("ComponentProvider", "Removing Datastore"), 
 ...
 */ function Yo(t, e) {
    ...
    if (t = s(t), Vo("collection", "path", e), t instanceof Qo) return qo(n = Q.fromString.apply(Q, _([ e ], r))), 
    new Ho(t, /* converter= */ null, n);
    if (!(t instanceof Wo || t instanceof Ho)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return qo(n = Q.fromString.apply(Q, _([ t.path ], r)).child(Q.fromString(e))), new Ho(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Xo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = V.u()), Vo("doc", "path", e), t instanceof Qo) return xo(n = Q.fromString.apply(Q, _([ e ], r))), 
    new Wo(t, 
    /* converter= */ null, new ot(n));
    if (!(t instanceof Wo || t instanceof Ho)) throw new A(I.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return xo(n = t._path.child(Q.fromString.apply(Q, _([ e ], r)))), new Wo(t.firestore, t instanceof Ho ? t.converter : null, new ot(n));
}
...
function Zo(t, e) {
    return t = s(t), e = s(e), t instanceof zo && e instanceof zo && t.firestore === e.firestore && Zt(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
/** A "context" object passed around while parsing user data. */ var ps = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Cc = function(e) {
        ...
        return Ps(t, this.settings.methodName, this.settings.Mc || !1, this.path, this.settings.Lc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ds(this.Dc) && hs.test(t)) throw this.Oc('Document fields cannot begin and end with "__"');
    }, t;
}(), ys = /** @class */ function() {
    function t(t, e, n) {
...
var bs = /** @class */ function(t) {
    ...
    return g(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new ve(t.R, se(t.R, this.Uc));
...
/** Parse update data from a list of field/value arguments. */ function As(t, e, n, r, i, o) {
    var u = t.Bc(1 /* Update */ , e, n), a = [ Cs(e, r, n) ], c = [ i ];
    ...
    for (var l = [], f = wt.empty(), d = a.length - 1; d >= 0; --d) if (!Ms(l, a[d])) {
        var p = a[d], y = c[d];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = s(y);
 ...
 */ function Ns(t, e, n, r) {
    return void 0 === r && (r = !1), Ss(n, t.Bc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ss(t, e) {
    ...
    return function(t, e) {
        ...
        if (!ds(e.Dc)) throw e.Oc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.Oc("Unsupported field value: " + Bo(t));
    }(t, e);
}
...
function ks(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x || t instanceof cs || t instanceof us || t instanceof Wo || t instanceof as);
}
 ...
 */
function Us(t, e) {
    return "string" == typeof e ? Ls(t, e) : e instanceof ss ? e._internalPath : e._delegate._internalPath;
}
 ...
 * limitations under the License.
 */ function Qs(t) {
    if (Qt(t) && 0 === t.explicitOrderBy.length) throw new A(I.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
 ...
 */
    ...
    return g(e, t), e.prototype._apply = function(t) {
        return new zo(t.firestore, t.converter, Jt(t._query, this.Gc, this.zc));
    }, e;
    ...
    return g(e, t), e.prototype._apply = function(t) {
        var e = $s(t, this.type, this.Hc, this.Jc);
        return new zo(t.firestore, t.converter, function(t, e) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], a = 0; a < i.length; a++) {
            ...
            if (s[a].field.isKeyField()) {
                ...
                if (!Ht(t) && -1 !== c.indexOf("/")) throw new A(I.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
...
function tu(t, e, n) {
    if ("string" == typeof (n = s(n))) {
        ...
        if (!Ht(e) && -1 !== n.indexOf("/")) throw new A(I.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    ...
    throw new A(I.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Bo(n) + ".");
}
 ...
 */ var ru = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new cs(Z(t.latitude), Z(t.longitude));
        ...
        L(Bn(n));
        var r = new Do(n.get(1), n.get(3)), i = new ot(n.popFirst(5));
        return r.isEqual(e) || 
...
/** Immutable class holding a blob (binary data) */ var vu = /** @class */ function() {
    ...
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        throw new A(I.FAILED_PRECONDITION, mu);
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
        ...
        void 0 === n && (n = {}), function(t, e, n, r) {
            ...
            t._setSettings(Object.assign(Object.assign({}, i), {
                ...
                t._credentials = new Oo(new Ro(o, new kr(s)));
            }
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                                return w(this, void 0, void 0, (function() {
                                    ...
                                    return b(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = P(t)).Or.add(0 /* UserDisabled */), [ 4 /*yield*/ , zr(e) ];
 ...
 */;
        ...
        get: function() {
            if (!this.Xc) throw new A(I.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Xc;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Cu(this, function(t, e) {
                if (t = jo(t, Qo), Vo("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new A(I.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new zo(t, 
                /* converter= */ null, 
                /**
 ...
 */
    ...
    return g(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Au.Zc(e, this.firestore, /* converter= */ null);
    }, e;
}(ru);
...
var Au = /** @class */ function() {
    ...
    return t.nu = function(e, n, r) {
        ...
        return lu(jo((t = this._delegate).firestore, rs), [ new Ve(t._key, _e.none()) ]);
        var t;
        /**
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        return new t(this.firestore, e ? this._delegate.withConverter(Iu.tu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var ku = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        try {
            return new t(this.firestore, zs(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Zs("endBefore", t, /*before=*/ !0);
            }.apply(void 0, e)));
        } catch (e) {
        ...
        try {
            return new t(this.firestore, zs(this._delegate, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new Zs("endAt", t, /*before=*/ !1);
            }.apply(void 0, e)));
        } catch (e) {
     ...
     */
        function(t) {
            ...
            return new Lu(e.firestore, new js(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Su(e), i = Du(e, (function(e) {
            return new Lu(t.firestore, new js(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return hu(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Iu.tu(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return g(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Iu.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Cu);
...
export { vu as $, wu as B, ku as J, Tu as K, gu as M, x as O, Eu as Q, cs as S, _u as U, Au as W, Cu as X, Ru as Y, Pu as e, ns as g, Fu as i, xu as o, rs as p, Uu as r, Vu as s, Lu as t };
//# sourceMappingURL=prebuilt-1a51925e-13f69621.js.map
