 ...
 */ var E = "8.5.0-20214541157", _ = /** @class */ function() {
    function t(t, e) {
        var n = this;
 ...
 */ function k(t) {
    ...
    if (D.logLevel <= h.DEBUG) {
        var r = e.map(R);
        D.debug.apply(D, b([ "Firestore (" + E + "): " + t ], r));
    }
}
...
function x(t) {
    ...
    if (D.logLevel <= h.ERROR) {
        var r = e.map(R);
        D.error.apply(D, b([ "Firestore (" + E + "): " + t ], r));
    }
}
...
function C(t) {
    ...
    if (D.logLevel <= h.WARN) {
        var r = e.map(R);
        D.warn.apply(D, b([ "Firestore (" + E + "): " + t ], r));
    }
}
...
/** Extracts the backend's type order for the provided value. */ function ct(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? nt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : O();
}
 ...
 */ var Tt = /** @class */ function() {
    ...
    t.prototype.applyOverlay = function(e, n) {
        var r = this, i = !1, o = t.extractNestedValue(this.partialValue, e), s = It(o) ? // If there is already data at the current path, base our
    ...
    t.prototype.buildProto = function() {
        var t = this.applyOverlay(Y.emptyPath(), this.overlayMap);
        ...
        for (var n = t, r = 0; r < e.length - 1; ++r) {
            ...
            if (!It(n = n.mapValue.fields[e.get(r)])) return null;
        }
...
var xt = /** @class */ function(t) {
     ...
     */    return w(e, t), e.create = function(t, n, r) {
        return t.isKeyField() ? "in" /* IN */ === n || "not-in" /* NOT_IN */ === n ? this.l(t, n, r) : new Ct(t, n, r) : "array-contains" /* ARRAY_CONTAINS */ === n ? new Pt(t, r) : "in" /* IN */ === n ? new Mt(t, r) : "not-in" /* NOT_IN */ === n ? new Ft(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === n ? new Vt(t, r) : new e(t, n, r);
    }, e.l = function(t, e, n) {
        return "in" /* IN */ === e ? new Rt(t, n) : new Ot(t, n);
 ...
 */ function Zt(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new Bt(n)), e.p.push(new Bt(Y.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function le(t, e, n) {
    return t instanceof ye ? function(t, e) {
        ...
        return mt(n) && mt(t.A) ? ce(r) : ae(t.R, r);
    }(t, e);
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && q(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof ve && e instanceof ve || t instanceof ge && e instanceof ge ? q(t.elements, e.elements, ht) : t instanceof be && e instanceof be ? ht(t.A, e.A) : t instanceof ye && e instanceof ye;
...
}(), $e = new Qe(at.comparator);

function Xe() {
    return $e;
}

var Je = new Qe(at.comparator);

function Ze() {
    return Je;
}

var tn = new Qe(at.comparator);

function en() {
    return tn;
}

var nn = new He(at.comparator);
 ...
 */ var un = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, an.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(j.min(), r, sn(), Xe(), rn());
    }, t;
}(), an = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(X.EMPTY_BYTE_STRING, n, rn(), rn(), rn());
    }, t;
}(), cn = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (kt(i)) if (0 === n) {
                ...
                // queries.
                var o = new at(i.path);
                this.tt(e, o, _t.newNoDocument(o, j.min()));
    ...
    t.prototype.ut = function(t) {
        ...
        return this.H = Xe(), this.J = pn(), this.Y = new He(V), i;
    }, 
    /**
    ...
    t.prototype.U = function(t) {
        ...
        var e = this.J.get(t);
        return e || (e = new He(V), this.J = this.J.insert(t, e)), e;
    }, 
    /**
...
function Tn(t) {
    return L(!!t), j.fromTimestamp(function(t) {
        var e = Z(t);
        return new B(e.seconds, e.nanos);
    }(t));
}
    ...
    var n = e.currentDocument ? function(t) {
        ...
        return function(t, e) {
            ...
            if ("setToServerValue" in e) L("REQUEST_TIME" === e.setToServerValue), n = new ye; else if ("appendMissingElements" in e) {
                ...
                n = new ge(i);
            } else "increment" in e ? n = new be(t, e.increment) : O();
 ...
 */ function Jn(t) {
    ...
    var e = t.length;
    if (L(e >= 2), 2 === e) return L("" === t.charAt(0) && "" === t.charAt(1)), W.emptyPath();
...
var yr = b(b([], b(b([], b(b([], b(b([], [ er.store, nr.store, rr.store, sr.store, ar.store, tr.store, hr.store, cr.store ]), [ lr.store ])), [ ur.store ])), [ fr.store ])), [ dr.store, pr.store ]), vr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", mr = /** @class */ function() {
    ...
    /** Deletes the specified database. */    return e.delete = function(t) {
        return k("SimpleDb", "Removing database:", t), Nr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === n.name ? r(new N(S.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Er(t, n));
 ...
 */ var Sr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return k("SimpleDb", "ADD", this.store.name, t, t), Nr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return k("SimpleDb", "DELETE", this.store.name, t), Nr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return k("SimpleDb", "COUNT", this.store.name), Nr(this.store.count());
...
/** Decodes a remote document from storage locally to a Document. */ function Pr(t, e) {
    ...
    if (e.noDocument) {
        var n = at.fromSegments(e.noDocument.path), r = Ur(e.noDocument.readTime), i = _t.newNoDocument(n, r);
...
/** Decodes a DbTarget into TargetData */ function jr(t) {
    var e, n, r = Ur(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Ur(t.lastLimboFreeSnapshotVersion) : j.min();
...
function Kr(t, e) {
    ...
    n = kt(e.target) ? Pn(t.Lt, e.target) : Mn(t.Lt, e.target);
 ...
 */ var Hr = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new He(W.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new He(W.comparator)).toArray();
    }, t;
}(), $r = /** @class */ function() {
    function t() {
        /**
...
var ni = /** @class */ function() {
    ...
    t.prototype.jt = function(t, e) {
        ...
        var n = this, r = e.path, i = r.length + 1, o = rr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new He(V);
        return oi(t).$t({
            range: s
        }, (function(t, e, o) {
 ...
 */ var ui = /** @class */ function() {
    ...
    t.prototype.ee = function(t, e) {
        ...
        return r.$t({
            ...
            var r = Jn(t[1]), o = new at(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = Yn(e.path), r = IDBKeyRange.bound([ n ], [ U(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return fi(t).$t({
 ...
 */ function li(t) {
    return I(this, void 0, void 0, (function() {
        return T(this, (function(e) {
            if (t.code !== S.FAILED_PRECONDITION || t.message !== vr) throw t;
            ...
            return I(e, void 0, void 0, (function() {
                ...
                return T(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return _r(e = n.sent()) ? (k("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
 ...
 */ var wi = /** @class */ function() {
     ...
     */
    t.prototype.Ee = function(t, e) {
        var n = this, r = Xe(), i = new Qe(at.comparator);
        return this.pe(t, e, (function(t, e) {
            var o = n.ye(t, e);
    ...
    return w(e, t), e.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.document.isValidDocument()) {
                ...
                var h = Mr(e.Ie.R, _t.newNoDocument(o, j.min()), e.getReadTime(o));
...
var Ai = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", ki = /** @class */ function() {
    ...
    h) {
        ...
        this.referenceDelegate = new mi(this, i), this.Le = n + "main", this.R = new Lr(a), 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new N(S.FAILED_PRECONDITION, Ai);
    ...
    t.prototype.fn = function() {
        ...
        return this.Be.runTransaction(t, o, yr, (function(o) {
            return i = new kr(o, r.Ne ? r.Ne.next() : _.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw x("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new N(S.FAILED_PRECONDITION, vr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return xi(t).get(tr.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.cn(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new N(S.FAILED_PRECONDITION, Ai);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        ...
        return n.get(tr.key).next((function(t) {
            return e.tn(t) ? (k("IndexedDbPersistence", "Releasing primary lease."), n.delete(tr.key)) : wr.resolve();
        }));
    }, 
 ...
 */
        ...
        for (var r = rn(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
            a instanceof Le && null === n.get(a.key) && (r = r.add(a.key));
        }
        var c = n;
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (Ht(e) || Yt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (A() <= h.DEBUG && k("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ie(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return A() <= h.DEBUG && k("QueryEngine", "Using full collection scan to execute query:", ie(e)), 
              ...
              case 0:
                return n = P(t), r = n._n, i = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        i = new Li(n.On, r, n.persistence.getIndexManager()), r.getAllMutationBatches(t);
                    })).next((function(e) {
 ...
 */ function Wi(t, e, n) {
    ...
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            ...
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : j.min(), n ? o : rn());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
 ...
 */ function Xi(t, e, n, r) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(p) {
            switch (p.label) {
              case 0:
                for (i = P(t), o = rn(), s = Xe(), u = en(), a = 0, c = n; a < c.length; a++) h = c[a], 
                ...
                return l = i.On.newChangeBuffer({
                    ...
                    return te(Wt(W.fromString("__bundle__/docs/" + t)));
                }(r)) ];
              ...
              case 1:
                ...
                return d = p.sent(), [ 2 /*return*/ , i.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Ki(t, l, s, j.min(), u).next((function(e) {
                        return l.apply(t), e;
                    })).next((function(e) {
 ...
 */ var Zi = /** @class */ function() {
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new at(new W([])), r = new eo(n, t), i = new eo(n, t + 1), o = [];
        ...
        var e = new at(new W([])), n = new eo(e, t), r = new eo(e, t + 1), i = rn();
    ...
    return t.prototype.checkEmpty = function(t) {
        ...
        var o = new eo(new at(i), 0), s = new He(V);
    ...
    function t(t, e) {
        ...
        this.docs = new Qe(at.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        for (var r = Xe(), i = new at(e.path.child("")), o = this.docs.getIteratorFrom(i)
    ...
    function t(t, e) {
        ...
        }(this.Ut), this.R = new Lr(e), this.Qe = new Zi(this.R);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
...
var po = /** @class */ function() {
    ...
    return t.Vs = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = sn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = ut(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.ks = new Qe(V), this.started = !1, 
        /**
    ...
    return w(u, t), u.prototype.ki = function(t, e, n, r) {
        ...
        var d = c.createWebChannel(l, f), w = !1, b = !1, I = new _o({
            Ei: function(t) {
                b ? k("Connection", "Not sending because WebChannel is closed:", t) : (w || (k("Connection", "Opening WebChannel transport."), 
                d.open(), w = !0), k("Connection", "WebChannel sending:", t), d.send(t));
            },
            Ti: function() {
                return d.close();
            }
        ...
        return T(d, v.EventType.OPEN, (function() {
            b || k("Connection", "WebChannel transport opened.");
        })), T(d, v.EventType.CLOSE, (function() {
            b || (b = !0, k("Connection", "WebChannel transport closed"), I.Vi());
        })), T(d, v.EventType.ERROR, (function(t) {
            b || (b = !0, C("Connection", "WebChannel transport errored:", t), I.Vi(new N(S.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    b = !0, I.Vi(new N(s, u)), d.close();
                } else k("Connection", "WebChannel received:", n), I.Si(n);
            }
        })), T(h, m.STAT_EVENT, (function(t) {
            t.stat === g.PROXY ? k("Connection", "Detected buffering proxy") : t.stat === g.NOPROXY && k("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
    ...
    t.prototype.Fi = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/" + E, 
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (L(void 0 === e || "string" == typeof e), X.fromBase64String(e || "")) : (L(void 0 === e || e instanceof Uint8Array), 
            ...
            i = Nn(t, r.document), o = r.readTime ? Tn(r.readTime) : j.min(), u = _t.newNoDocument(i, o), 
    ...
    e.prototype.mr = function(t) {
        ...
        e.database = kn(this.R), e.addTarget = function(t, e) {
            ...
            return (n = kt(r) ? {
                ...
                query: Mn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = bn(t, e.resumeToken) : e.snapshotVersion.compareTo(j.min()) > 0 && (
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return I(this, void 0, void 0, (function() {
                                ...
                                return T(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = P(t)).Or.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Fo(e) ];
    ...
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(s) {
            switch (s.label) {
              ...
              case 6:
                if (e instanceof cn ? t.qr.X(e) : e instanceof hn ? t.qr.rt(e) : t.qr.et(e), n.isEqual(j.min())) return [ 3 /*break*/ , 13 ];
                s.label = 7;
              ...
              case 11:
                return k("RemoteStore", "Failed to raise snapshot:", o = s.sent()), [ 4 /*yield*/ , Yo(t, o) ];
        ...
        return T(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.Or.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Fo(t) ];
...
function Xo(t) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(s) {
            switch (s.label) {
              case 0:
                e = P(t), n = ss(e), r = e.kr.length > 0 ? e.kr[e.kr.length - 1].batchId : -1, s.label = 1;
                ...
                return e && ss(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return I(this, void 0, void 0, (function() {
                        ...
                        return T(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return Ke(r = e.code) && r !== S.ABORTED ? (n = t.kr.shift(), 
    ...
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(i) {
            switch (i.label) {
              ...
              case 2:
                return (r = e) ? [ 3 /*break*/ , 4 ] : (n.Or.add(2 /* IsSecondary */), [ 4 /*yield*/ , Fo(n) ]);
 ...
 */ function as(t, e) {
    if (x("AsyncQueue", e + ": " + t), _r(t)) return new N(S.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ function ps(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = P(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new ls), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new Le(c.key, h, Et(h.toProto().mapValue), Se.exists(!0)));
                            }
        ...
        return T(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                (o = i && i.key) ? (s = (s = new Qe(at.comparator)).insert(o, _t.newNoDocument(o, j.min())), 
                u = rn().add(o), a = new un(j.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new He(V), s, u), [ 4 /*yield*/ , Ls(r, a) ]) : [ 3 /*break*/ , 2 ];
...
function Gs(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof _s ? (t.No.addReference(o.key, e), Qs(t, o)) : o instanceof Ss ? (k("SyncEngine", "Document no longer in limbo: " + o.key), 
 ...
 */ function zs(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.Co.set(r, new As(n)), t.Do = t.Do.insert(n, r), Vo(t.remoteStore, new Or(te(Wt(n.path)), r, 2 /* LimboResolution */ , _.o));
    }
}
 ...
 */ function $s(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , Wi((n = P(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];
...
function Xs(t) {
    return I(this, void 0, void 0, (function() {
        var e;
        return T(this, (function(n) {
            return [ 2 /*return*/ , Yi((e = P(t)).localStore).then((function(t) {
                return Ws(e, t);
            })) ];
        }));
    }));
...
function Zs(t, e) {
    return I(this, void 0, void 0, (function() {
        ...
        return T(this, (function(h) {
            switch (h.label) {
              case 0:
                return ou(n = P(t)), su(n), !0 !== e || !0 === n.$o ? [ 3 /*break*/ , 3 ] : (r = n.sharedClientState.getAllActiveQueryTargets(), 
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Co.forEach((function(t, n) {
                        qo(e.remoteStore, n);
                    })), e.No.ts(), e.Co = new Map, e.Do = new Qe(at.comparator);
        ...
        return T(this, (function(d) {
            switch (d.label) {
              ...
              case 1:
                ...
                k("SyncEngine", "Adding an already active target " + s), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Hi(r.localStore, s) ]) : [ 3 /*break*/ , 6 ];
...
function ou(t) {
    var e = P(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Ls.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Ys.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Ms.bind(null, e), e.vo._r = vs.bind(null, e.eventManager), 
    e.vo.Mo = ms.bind(null, e.eventManager), e;
}

function su(t) {
    var e = P(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Fs.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Vs.bind(null, e), 
    e
    /**
...
var au = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        return Vi(this.persistence, new Mi, t.initialUser, this.R);
    }, t.prototype.qo = function(t) {
    ...
    return w(e, t), e.prototype.initialize = function(e) {
        ...
        var e = No();
        if (!wo.yt(e)) throw new N(S.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ var du = /** @class */ function() {
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return I(this, void 0, void 0, (function() {
                            ...
                            return T(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = P(t), r = kn(n.R) + "/documents", i = {
    ...
    e, n) {
        ...
        this.clientId = F.u(), this.credentialListener = function() {}, this.receivedInitialUser = new gr, 
        this.credentials.setChangeListener((function(t) {
            k("FirestoreClient", "Received user=", t.uid), r.user = t, r.credentialListener(t), 
                    ...
                    r.isEqual(n) || (r = n, t.asyncQueue.enqueueRetryable((function() {
                        return I(i, void 0, void 0, (function() {
                            return T(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , qi(e.localStore, n) ];
                                ...
                                return T(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        ...
                                        n.Or.add(3 /* CredentialChange */), [ 4 /*yield*/ , Fo(n) ];
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        ...
        this.currentUser = co.UNAUTHENTICATED, this.receivedInitialUser = !1, 
        /**
    ...
    function t(t, e, n) {
        this.ac = t, this.hc = e, this.lc = n, this.type = "FirstParty", this.user = co.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Mu(this.ac, this.hc, this.lc));
    }, t.prototype.setChangeListener = function(t) {
 ...
 */
        return t = this, (e = Cu.get(t)) && (k("ComponentProvider", "Removing Datastore"), 
 ...
 */ function Xu(t, e) {
    ...
    if (t = u(t), Vu("collection", "path", e), t instanceof Wu) return ju(n = W.fromString.apply(W, b([ e ], r))), 
    new $u(t, /* converter= */ null, n);
    if (!(t instanceof Hu || t instanceof $u)) throw new N(S.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return ju(n = W.fromString.apply(W, b([ t.path ], r)).child(W.fromString(e))), new $u(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Ju(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = F.u()), Vu("doc", "path", e), t instanceof Wu) return Bu(n = W.fromString.apply(W, b([ e ], r))), 
    new Hu(t, 
    /* converter= */ null, new at(n));
    if (!(t instanceof Hu || t instanceof $u)) throw new N(S.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Bu(n = t._path.child(W.fromString.apply(W, b([ e ], r)))), new Hu(t.firestore, t instanceof $u ? t.converter : null, new at(n));
}
    ...
    t.prototype.Ac = function() {
        ...
        var e = this, n = this.fc.then((function() {
            return e.yc = !0, t().catch((function(t) {
                ...
                throw e.mc = t, e.yc = !1, x("INTERNAL UNHANDLED ERROR: ", 
                /**
...
function(t) {
    ...
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new Le(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Oe(t, this.data, e, this.fieldTransforms);
    }, t;
}(), va = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var ga = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Cc = function(e) {
        ...
        return Va(t, this.settings.methodName, this.settings.Mc || !1, this.path, this.settings.Lc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ma(this.Dc) && pa.test(t)) throw this.Oc('Document fields cannot begin and end with "__"');
    }, t;
}(), wa = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function Ia(t, e, n, r, i, o) {
    ...
    La("Data must be an object, but it was:", s, r);
    var u, a, c = Ra(r, s);
...
var Ta = /** @class */ function(t) {
    ...
    return w(e, t), e.prototype._toFieldTransform = function(t) {
        if (2 /* MergeSet */ !== t.Dc) throw 1 /* Update */ === t.Dc ? t.Oc(this._methodName + "() can only appear at the top level of your update data") : t.Oc(this._methodName + "() cannot be used with set() unless you pass {merge:true}");
...
var _a = /** @class */ function(t) {
    ...
    return w(e, t), e.prototype._toFieldTransform = function(t) {
        var e = new be(t.R, he(t.R, this.Uc));
...
/** Parse update data from an update() call. */ function Aa(t, e, n, r) {
    ...
    La("Data must be an object, but it was:", i, r);
    var o = [], s = Tt.empty();
    G(r, (function(t, r) {
        var a = Fa(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function ka(t, e, n, r, i, o) {
    var s = t.Bc(1 /* Update */ , e, n), a = [ Pa(e, r, n) ], c = [ i ];
 ...
 */ function xa(t, e, n, r) {
    return void 0 === r && (r = !1), Ca(n, t.Bc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Ca(t, e) {
    ...
    // from firestore-exp.
    t = u(t))) return La("Unsupported field value:", e, t), Ra(t, e);
    if (t instanceof la) 
    ...
    return function(t, e) {
        ...
        if (!ma(e.Dc)) throw e.Oc(t._methodName + "() can only be used with update() and set()");
    ...
    e.path && e.fieldMask.push(e.path), t instanceof Array) {
        ...
        if (e.settings.xc && 4 /* ArrayArgument */ !== e.Dc) throw e.Oc("Nested arrays are not supported");
        return function(t, e) {
    ...
    return function(t, e) {
        ...
        throw e.Oc("Unsupported field value: " + Ku(t));
    }(t, e);
}
...
function Oa(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof B || t instanceof da || t instanceof fa || t instanceof Hu || t instanceof la);
}
 ...
 * evaluated.
 */ function Fa(t, e, n) {
    if (e.search(Ma) >= 0) throw Va("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
 ...
 */
function ja(t, e) {
    return "string" == typeof e ? Fa(t, e) : e instanceof ha ? e._internalPath : e._delegate._internalPath;
}
 ...
 * limitations under the License.
 */ function Ya(t) {
    if (Yt(t) && 0 === t.explicitOrderBy.length) throw new N(S.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
 ...
 */
    ...
    return w(e, t), e.prototype._apply = function(t) {
        return new Yu(t.firestore, t.converter, ee(t._query, this.Gc, this.zc));
    }, e;
    ...
    return w(e, t), e.prototype._apply = function(t) {
        var e = rc(t, this.type, this.Hc, this.Jc);
        return new Yu(t.firestore, t.converter, function(t, e) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], a = 0; a < i.length; a++) {
            ...
            if (s[a].field.isKeyField()) {
                ...
                if (!Jt(t) && -1 !== c.indexOf("/")) throw new N(S.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
...
function ic(t, e, n) {
    if ("string" == typeof (n = u(n))) {
        ...
        if (!Jt(e) && -1 !== n.indexOf("/")) throw new N(S.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
    ...
    if (n instanceof Hu) return vt(t, n._key);
    throw new N(S.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Ku(n) + ".");
}
 ...
 */ var uc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new da(tt(t.latitude), tt(t.longitude));
    ...
    return Object.defineProperty(t.prototype, "_databaseId", {
        ...
        void 0 === n && (n = {}), function(t, e, n, r) {
            ...
            t._setSettings(Object.assign(Object.assign({}, i), {
                ...
                t._credentials = new Lu(new Ru(o, new co(s)));
            }
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                                return I(this, void 0, void 0, (function() {
                                    ...
                                    return T(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = P(t)).Or.add(0 /* UserDisabled */), [ 4 /*yield*/ , Fo(e) ];
 ...
 */;
        ...
        get: function() {
            if (!this.Xc) throw new N(S.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Xc;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Lc(this, function(t, e) {
                if (t = Gu(t, Wu), Vu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new N(S.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Yu(t, 
                /* converter= */ null, 
                /**
 ...
 */
    ...
    return w(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Ac.Zc(e, this.firestore, /* converter= */ null);
    }, e;
}(uc);
...
var Ac = /** @class */ function() {
    ...
    return t.nu = function(e, n, r) {
        ...
        return new t(n, new Hu(n._delegate, r, new at(e)));
    }, t.Zc = function(e, n, r) {
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        return new t(this.firestore, e ? this._delegate.withConverter(Dc.tu(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Rc = /** @class */ function() {
     ...
     */
        function(t) {
            ...
            return new Mc(e.firestore, new za(e.firestore._delegate, e._userDataWriter, e._delegate, t._snapshot));
        }));
    }, t.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = xc(e), i = Cc(e, (function(e) {
            return new Mc(t.firestore, new za(t.firestore._delegate, t._userDataWriter, t._delegate, e._snapshot));
        }));
        return pc(this._delegate, r, i);
    }, t.prototype.withConverter = function(e) {
        return new t(this.firestore, e ? this._delegate.withConverter(Dc.tu(this.firestore, e)) : this._delegate.withConverter(null));
    ...
    return Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Lc(this._firestore, this._delegate.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "metadata", {
    ...
    return w(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Dc.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Lc);
...
function jc(t) {
    ...
    return (e = this._delegate, n = t, function(t, e) {
        ...
        return t ? new Lc(r, t) : null;
    }));
}

export { bc as $, Tc as B, Rc as J, Nc as K, Ic as L, B as O, Sc as Q, da as S, _c as U, Ac as W, Lc as X, Oc as Y, Fc as e, ia as g, Uc as i, jc as o, oa as p, Bc as r, qc as s, Mc as t };
//# sourceMappingURL=prebuilt-70739a6c-6dcf5afb.js.map
