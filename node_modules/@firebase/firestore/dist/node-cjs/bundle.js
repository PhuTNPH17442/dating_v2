...
function loadBundle(data) {
    return database75439ad2.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database75439ad2.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database75439ad2.Query$1(_this, 
...
registerBundle(database75439ad2.Firestore);
