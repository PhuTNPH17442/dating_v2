...
function ht(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = F(X(t.latitude), X(e.latitude));
            if (0 !== n) return n;
            return F(X(t.longitude), X(e.longitude));
...
function lt(t, e) {
    ...
    const n = Y(t), s = Y(e), i = F(n.seconds, s.seconds);
 ...
 */ class Et {
     ...
     */    field(t) {
        return Et.extractNestedValue(this.buildProto(), t);
    }
     ...
     */    applyOverlay(t, e) {
        let n = !1;
        const s = Et.extractNestedValue(this.partialValue, t), i = pt(s) ? // If there is already data at the current path, base our
 ...
 */ function fe(t, e, n) {
    return t instanceof _e ? function(t, e) {
        ...
        return _t(n) && _t(t.A) ? ae(s) : ue(t.R, s);
    }(t, e);
}
 ...
 */ function we(t, e) {
    return t instanceof Ee ? _t(n = e) || function(t) {
...
function Re(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof me && e instanceof me || t instanceof ge && e instanceof ge ? $(t.elements, e.elements, ut) : t instanceof Ee && e instanceof Ee ? ut(t.A, e.A) : t instanceof _e && e instanceof _e;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const Ye = new We(ot.comparator);

function Xe() {
    return Ye;
}

const Ze = new We(ot.comparator);

function tn() {
    return Ze;
}

const en = new We(ot.comparator);

function nn() {
    return en;
}

const sn = new He(ot.comparator);
 ...
 */ class an {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new an(H.EMPTY_BYTE_STRING, e, rn(), rn(), rn());
    }
}
...
function Sn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? K.emptyPath() : Cn(e);
}
...
function Qn(t) {
    return t ? void 0 !== t.unaryFilter ? [ Yn(t) ] : void 0 !== t.fieldFilter ? [ Jn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Qn(t))).reduce(((t, e) => t.concat(e))) : D() : [];
}
 ...
 */ class vs {
    ...
    constructor(t, n, s) {
        ...
        // log on 12.2.
        12.2 === vs._t(e()) && P("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
...
/** Decodes a remote document from storage locally to a Document. */ function Bs(t, e) {
    ...
    if (e.noDocument) {
        const t = ot.fromSegments(e.noDocument.path), n = js(e.noDocument.readTime), s = It.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = ot.fromSegments(e.unknownDocument.path), n = js(e.unknownDocument.version);
...
/** Decodes a DbTarget into TargetData */ function Gs(t) {
    ...
    s = te(Gt(Sn(i.documents[0])))) : s = function(t) {
        return te(qn(t));
    }(t.query), new Ms(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, H.fromBase64String(t.resumeToken));
}
 ...
 */ class ti {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new He(K.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new He(K.comparator)).toArray();
    }
}
 ...
 */ class vi {
     ...
     */    Ee(t, e) {
        let n = Xe(), s = new We(ot.comparator);
        return this.pe(t, e, ((t, e) => {
            const i = this.ye(t, e);
 ...
 */
    ...
    Je(t) {
        return Fi(t).get(rs.key).next((t => Rs.resolve(this.tn(t))));
    }
    en(t) {
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Be.runTransaction(t, s, Es, (s => (i = new ks(s, this.Ne ? this.Ne.next() : T.o), 
...
// PORTING NOTE: Multi-Tab only.
function Zi(t, e) {
    const n = N(t), s = N(n.qe), i = n.kn.get(e);
...
async function nr(t, e, n, s) {
    ...
    const u = i.On.newChangeBuffer({
        ...
        return te(Gt(K.fromString(`__bundle__/docs/${t}`)));
    }(s));
 ...
 */ class rr {
     ...
     * removed.
     */    Zn(t) {
        const e = new ot(new K([])), n = new or(e, t), s = new or(e, t + 1), i = [];
    ...
    es(t) {
        const e = new ot(new K([])), n = new or(e, t), s = new or(e, t + 1);
        let i = rn();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
...
class ur {
    ...
    constructor(t, e) {
        ...
        this.docs = new We(ot.comparator), 
 ...
 */ class Ar {
    constructor(t, e, n, s, i) {
        ...
        this.Fs = new We(F), this.started = !1, 
        /**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Fs = this.Fs.insert(this.Ns, new Ir), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
...
class {
    ...
    Oi(t, e) {
        ...
        // on a closed stream
                const T = new Vr({
            Ei: t => {
                E ? v("Connection", "Not sending because WebChannel is closed:", t) : (w || (v("Connection", "Opening WebChannel transport."), 
        ...
        // enough the code is exception free.
            ...
            E || v("Connection", "WebChannel transport opened.");
        })), R(d, y.EventType.CLOSE, (() => {
            E || (E = !0, v("Connection", "WebChannel transport closed"), T.Vi());
        })), R(d, y.EventType.ERROR, (t => {
            E || (E = !0, V("Connection", "WebChannel transport errored:", t), T.Vi(new A(I.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    E = !0, T.Vi(new A(e, n)), d.close();
                } else v("Connection", "WebChannel received:", n), T.Si(n);
            }
        })), R(h, g.STAT_EVENT, (t => {
            t.stat === p.PROXY ? v("Connection", "Detected buffering proxy") : t.stat === p.NOPROXY && v("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
 ...
 */ function fo(t) {
    ...
    t.Qr = function(t, e, n) {
        ...
        await eo(t)) : (await t.Qr.stop(), t.Fr.length > 0 && (v("RemoteStore", `Stopping write stream with ${t.Fr.length} pending writes`), 
        t.Fr = []));
    }))), t.Qr;
}
        ...
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Mn.pn(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new Fe(t.key, e, Tt(e.toProto().mapValue), ve.exists(!0)));
                }
 ...
 */ function Zo(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new ot(K.fromString(e)), s = t.Fo.next();
...
async function oc(t, e) {
    ...
    if (fc(n), dc(n), !0 === e && !0 !== n.$o) {
        ...
        function(t) {
            ...
            e.Co.forEach(((t, n) => {
                Qr(e.remoteStore, n);
            })), e.No.ts(), e.Co = new Map, e.Do = new We(ot.comparator);
        }
        /**
 ...
 */ class mc extends _c {
    ...
    qo(t) {
        ...
        return new ki(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Dr(), Cr(), this.R, this.sharedClientState, !!this.forceOwnership);
    }
    Bo(t) {
        return new Rr;
    }
...
class Rc {
    ...
    e, n) {
        ...
        this.clientId = k.u(), this.credentialListener = () => {}, this.receivedInitialUser = new As, 
        this.credentials.setChangeListener((t => {
            v("FirestoreClient", "Received user=", t.uid), this.user = t, this.credentialListener(t), 
...
class Jc {
    constructor(t) {
        ...
        this.currentUser = wr.UNAUTHENTICATED, this.receivedInitialUser = !1, 
        /**
 ...
 */ class Yc {
    constructor(t, e, n) {
        this.ac = t, this.hc = e, this.lc = n, this.type = "FirstParty", this.user = wr.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
 ...
 */ class Xc {
    ...
    getToken() {
        return Promise.resolve(new Yc(this.ac, this.hc, this.lc));
    }
    setChangeListener(t) {
...
function wu(t, e, ...n) {
    ...
    }
    {
        ...
        return nu(s), new au(t.firestore, t instanceof lu ? t.converter : null, new ot(s));
    }
}
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = wo.createAndSchedule(this, t, e, n, (t => this.Rc(t)));
 ...
 */ class Su {
     ...
     */    static fromBase64String(t) {
        try {
            return new Su(H.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Su(H.fromUint8Array(t));
    }
    /**
...
/** A "context" object passed around while parsing user data. */ class $u {
    ...
    Oc(t) {
        return na(t, this.settings.methodName, this.settings.Mc || !1, this.path, this.settings.Lc);
    }
    ...
    kc(t) {
        ...
        if (Fu(this.Dc) && Nu.test(t)) throw this.Oc('Document fields cannot begin and end with "__"');
    }
}
...
class Qu extends Du {
    ...
    _toFieldTransform(t) {
        const e = qu(this, t, 
        /*array=*/ !0), n = this.qc.map((t => Hu(t, e))), s = new me(n);
...
class Ku extends Du {
    ...
    _toFieldTransform(t) {
        const e = qu(this, t, 
        /*array=*/ !0), n = this.qc.map((t => Hu(t, e))), s = new ge(n);
        return new Ae(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class ju extends Du {
    ...
    _toFieldTransform(t) {
        const e = new Ee(t.R, he(t.R, this.Uc));
...
/** Parse update data from a list of field/value arguments. */ function Gu(t, e, n, s, i, r) {
    const o = t.Bc(1 /* Update */ , e, n), c = [ Zu(e, s, n) ], u = [ i ];
 ...
 */ function zu(t, e, n, s = !1) {
    return Hu(n, t.Bc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!Fu(e.Dc)) throw e.Oc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.Oc(`Unsupported field value: ${iu(t)}`);
    }
    /**
 ...
 */ class ga extends wa {
    ...
    _apply(t) {
        return new hu(t.firestore, t.converter, ee(t._query, this.Gc, this.zc));
    }
}
 ...
 */ class pa extends wa {
    ...
    _apply(t) {
        const e = Ta(t, this.type, this.Hc, this.Jc);
        return new hu(t.firestore, t.converter, function(t, e) {
...
function Ta(t, e, n, s) {
    if (n[0] = a(n[0]), n[0] instanceof ia) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of Zt(t)) if (n.field.isKeyField()) r.push(wt(e, s.key)); else {
...
function Ia(t, e, n) {
    ...
    if (n instanceof au) return wt(t, n._key);
 ...
 */ class ba {
    ...
    convertGeoPoint(t) {
        return new Cu(X(t.latitude), X(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertDocumentKey(t, e) {
        ...
        C(Zn(n));
        const s = new jc(n.get(1), n.get(3)), i = new ot(n.popFirst(5));
        return s.isEqual(e) || 
 ...
 */ class La {
    enableIndexedDbPersistence(t, e) {
        throw new A(I.FAILED_PRECONDITION, Ma);
    }
...
class Ua extends ba {
    ...
    convertReference(t) {
        const e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Ga.Zc(e, this.firestore, /* converter= */ null);
    }
}
...
class Ga {
    ...
    static nu(t, e, n) {
        ...
        return new Ga(e, new au(e._delegate, n, new ot(t)));
    }
    static Zc(t, e, n) {
 ...
 */ (this._delegate) : function(t) {
    ...
    withConverter(t) {
        return new Ga(this.firestore, t ? this._delegate.withConverter(Wa.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
 ...
 */ (this._delegate) : "server" === (null == t ? void 0 : t.source) ? function(t) {
    ...
    withConverter(t) {
        return new Za(this.firestore, t ? this._delegate.withConverter(Wa.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
...
class nh extends Za {
    ...
    withConverter(t) {
        return new nh(this.firestore, t ? this._delegate.withConverter(Wa.tu(this.firestore, t)) : this._delegate.withConverter(null));
    }
}
 ...
 */ class ih {
    ...
    static documentId() {
         ...
         * effect is the same.
         */
        return new ih(W.keyField().canonicalString());
    }
    isEqual(t) {
